...
declare namespace apiRTC {
    ...
    class UserAgent extends Observable {
        ...
        unregister(opts?: any): Promise<void>;
    ...
    class Stream extends Observable {
        ...
        addInDiv(divId: string, mediaEltId: string, style: object, muted: boolean): void;
        removeFromDiv(divId: string, mediaEltId: string): void;
        blur(): Promise<Stream>;
        unblur(): void;
        getConstraints(): void;
        getSettings(): void;
        getCapabilities(): void;
        applyConstraint(capability: string, value: any): Promise<void>;
        applyConstraints(capabilities: any): Promise<void>;
        askRemoteCapabilityAuthorization(): void;
        acceptRemoteCapabilityRequest(contactId: string, roomName: string, callId: string);
        refuseRemoteCapabilityRequest(contactId: string, roomName: string, callId: string);
    }
    ...
    class Session extends Observable {
        ...
        getOrCreateConversation(name: string, opts?: GetOrCreateConversationOptions): Conversation|Conference;
        getOrCreateConference(name: string, opts?: GetOrCreateConversationOptions): Conversation|Conference;
    ...
    interface JoinOptions {
        session?: Session;
        password?: string;
        qualityAdaptationEnabled?: boolean;
    }
    ...
    interface SimulcastSubscribeOptions {
    ...
    interface SubscribeOptions {
        ...
        simulcast?: SimulcastSubscribeOptions;
        audioOnly?: boolean;
        videoOnly?: boolean;
    }
    ...
    interface SimulcastOptions {
        maxBitrate?: number;
        encodings?: SimulcastEncodingsOptions;
    }

    interface SimulcastEncodingsOptions {
        high: SimulcastQualityOptions;
        medium: SimulcastQualityOptions;
        low: SimulcastQualityOptions;
    }

    interface SimulcastQualityOptions {
        maxBitrate: number;
    ...
    interface PublishOptions {
        ...
        videoOnly?: boolean;
        context?: object;
        distributedBroadcastEnabled?: boolean;
    ...
    class Conversation extends Observable {
        ...
        cancelPushData(id: string): Promise<void>;
        fetchMediaList(session: Session, opts: object): Promise<Array<object>>;
        fetchMessageHistory(session: Session, options?: object): Promise<Array<ConversationMessage>>;
        ...
        getModerator(): Contact|null;
        eject(contact: Contact, opts?: object): Promise<void>;
        sendJoinRequest(session: Session): void;
        sendPointerLocation(source: object, x: number, y: number, data?: object): void;
    }
