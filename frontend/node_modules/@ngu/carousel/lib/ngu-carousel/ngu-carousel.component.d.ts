...
export declare class NguCarousel<T> extends NguCarouselStore implements OnInit, AfterContentInit, AfterViewInit, OnDestroy, DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NguCarousel<any>, "ngu-carousel", never, { "inputs": "inputs"; "dataSource": "dataSource"; "trackBy": "trackBy"; }, { "carouselLoad": "carouselLoad"; "onMove": "onMove"; }, ["nextBtn", "prevBtn", "_defDirec"], ["[NguCarouselPrev]", "[NguCarouselNext]", "[NguCarouselPoint]"], false>;
}
